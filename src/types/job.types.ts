...
import type { JobSheetFromDB, JobSheetType } from "./jobSheet.types.js";
...
export type AggJobAndSheetType = {
    _id: string,
    jobName: string,
    client: string,
    location: string,
...
export type AggJobAndSheetFromDB = {
    _id: Types.ObjectId,
    jobName: string,
    client: string,
    location: string,
